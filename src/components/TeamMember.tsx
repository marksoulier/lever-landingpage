...
export const TeamMember: React.FC<TeamMemberProps> = ({
  ...
  return (
    <article className="flex flex-col grow items-center text-[14px] leading-8 text-black max-md:mt-10">
      <img
        src={image}
        alt={name}
      ...
      <a
        ...
        className="self-stretch mt-2 hover:text-sky-600 text-center"
      >
        {linkedin}
      </a>
    </article>
