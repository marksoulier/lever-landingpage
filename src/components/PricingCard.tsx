...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <article
      className={`flex grow items-end px-1 py-14 w-full bg-white rounded-3xl border border-solid ${variant === "featured"
    ...
    >
      ...
      <div className="flex flex-col items-start self-stretch w-full">
        ...
        <div className="flex items-center justify-center self-stretch mt-9">
          <a
            href="https://cal.com/lever-ai/lever-ai-demo"
            className={`h-[60px] w-[200px] rounded-[50px] font-medium transition-all duration-300 ease-in-out cursor-pointer flex items-center justify-center ${variant === "featured"
